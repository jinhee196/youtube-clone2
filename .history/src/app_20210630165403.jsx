...
function App() {
  ...
  const search = (param) => {
    ...
    fetch(
      "https://youtube.googleapis.com/youtube/v3/search?key=AIzaSyDLywHKXEhmr2x6ikNEUiT8UijZhU0xvdg&part=snippet&maxResults=25&q=bts&key=AIzaSyDLywHKXEhmr2x6ikNEUiT8UijZhU0xvdg",
      requestOptions
    )
