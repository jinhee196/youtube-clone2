class Youtube {
  ...
  search(query) {
    return fetch(
      ...
      `https://youtube.googleapis.com/youtube/v3/search?key=AIzaSyDLywHKXEhmr2x6ikNEUiT8UijZhU0xvdg&part=snippet&maxResults=25&q=${query}&type=video&key=AIzaSyDLywHKXEhmr2x6ikNEUiT8UijZhU0xvdg`,
      this.getRequestOptions
    )
      .then((response) => response.json())
      .then((result) =>
